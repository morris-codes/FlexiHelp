...
const ServiceDiscoveryPage = () => {
  const topRated = [
    ...
    { id: 3, name: 'Nk Cleaners', image: cleaner3, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 4, name: 'Nk Cleaners', image: cleaner4, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 5, name: 'Nk Cleaners', image: cleaner5, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 6, name: 'Nk Cleaners', image: cleaner6, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 7, name: 'Nk Cleaners', image: cleaner7, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 8, name: 'Nk Cleaners', image: cleaner8, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
  ];
