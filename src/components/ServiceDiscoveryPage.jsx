...
import { FaStar, FaMapMarkerAlt, FaUserCircle, FaSignOutAlt } from 'react-icons/fa';
...
import cleaner13 from '../assets/carps.jpg';
import cleaner14 from '../assets/elect.jpg';
...
const ServiceDiscoveryPage = () => {
  ...
  const topRated = [
    ...
    { id: 4, name: 'Dee’s Couture', image: cleaner5, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 5, name: 'Carpenter', image: cleaner13, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 6, name: 'Electrician', image: cleaner14, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
  ];
  ...
  const recommendations = [
    { id: 9, name: 'Clean Cutx', image: cleaner4, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
    { id: 10, name: 'Dee Couture', image: cleaner5, description: 'Squeaky clean services only. Let’s give your space the thorough cleaning it needs', rating: 4.9 },
          ...
          {topRated.map((provider) => (
            <div key={provider.id} className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 relative hover:shadow-md hover:-translate-y-1 transition-transform">
              ...
              <div className="flex items-center text-sm space-x-2">
                <button onClick={handleHireNowClick} className="bg-blue-500 text-white px-4 py-1 rounded-[20px] hover:bg-blue-600">Hire Now</button>
                <button className="text-blue-500 px-3 py-1 rounded-md hover:bg-blue-50">View Details</button>
              </div>
            </div>
          ))}
        </div>
          ...
          {nearby.map((item) => (
            <div key={item.id} className="flex flex-col sm:flex-row items-center bg-white border border-blue-100 rounded-xl shadow-sm p-3 relative hover:shadow-md transition-transform hover:-translate-y-1">
              ...
              <div className="flex-1 w-full">
                ...
                <button className=" text-black-500 px-4 py-1 rounded-full hover:bg-blue-50 text-sm w-full sm:w-auto">View Details</button>
              </div>
            </div>
          ))}
        </div>
