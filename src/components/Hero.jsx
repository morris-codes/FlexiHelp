    ...
    <section className="w-full min-h-screen bg-white text-[#0F172A] px-6 md:px-16 py-10">
      ...
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-5xl md:text-5xl font-medium leading-snug mt-15">
          <span className="text-yellow-500">Need Help?</span>{" "}
          <span className="text-[#095CAF]">
            Get it done <br className="hidden md:block" />
            with professionals!
          </span>
        </h1>
        ...
        <div className="mt-6 flex justify-center gap-4 flex-wrap">
          <button
            ...
            className="bg-[#095CAF] text-white px-14 py-2 rounded-2xl text-sm hover:bg-blue-800 font-semibold transition"
          >
            Book A Trusted Helper
          </button>
          <button
            onClick={onSignupClick}
            className="border border-[#095CAF] text-[#095CAF] px-14 py-2 font-semibold rounded-2xl text-sm hover:bg-blue-50 transition"
          >
      ...
      {/* Image Row */}
      <div className="mx-auto mt-[60px] w-[1402.5px] h-[438px] flex gap-[30px] justify-center">
        {[image1, image2, image3, image4].map((img, idx) => {
          const style = {
            transform: (idx === 1 || idx === 2) ? "scale(0.92)" : "scale(1)",
